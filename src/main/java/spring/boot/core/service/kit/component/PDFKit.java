...
import spring.boot.core.service.kit.component.builder.PDFBuilder;
import spring.boot.core.service.kit.exception.PDFException;
import spring.boot.core.service.kit.util.AsianFontProvider;
import spring.boot.core.service.kit.util.FreeMarkerUtil;
...
public class PDFKit {
     ...
     *
     */
    public String exportToFile(String fileName, String htmlData){
