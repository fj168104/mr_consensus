package spring.boot.core.service.kit.util;
...
import spring.boot.core.service.kit.exception.FreeMarkerException;
import spring.boot.core.service.kit.exception.PDFException;
...
//        String templateFilePath=getTemplatePath(templatePath);
        ...
        String templateFileName="bankData.ftl";
        URL fileResource = FreeMarkerUtil.class.getResource("/templates");
...
//        }
        try{
            ...
            config.setDirectoryForTemplateLoading(new File(fileResource.getFile()));
